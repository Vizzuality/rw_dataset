    ...
    context 'Populate datasets with metadata' do
      context 'datasets list' do
        before(:each) do
          ...
          with(:body => "{\"ids\":[\"baca8364-3aa8-5d74-8100-44ef25885e9a\"]}",
      ...
      context 'specific dataset without app' do
        before(:each) do
          stub_request(:get, "http://192.168.99.100:8000/metadata/baca8364-3aa8-5d74-8100-44ef25885e9a").
      ...
      context 'specific dataset' do
        before(:each) do
          stub_request(:get, "http://192.168.99.100:8000/metadata/baca8364-3aa8-5d74-8100-44ef25885e9a/prep").
          with(:headers => {'Accept'=>'application/json', 'Authentication'=>'3123123der324eewr434ewr4324'}).
          to_return(:status => 200, :body => Oj.dump(metadata_data), :headers => {})
        end
