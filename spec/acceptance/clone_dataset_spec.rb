    ...
    context 'For specific dataset' do
      context 'Rest dataset' do
        ...
        it 'Allows to clone cartodb dataset' do
          post "/dataset/#{dataset_id}/clone", params: {"loggedUser": {"role": "Manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
      ...
      context 'Json dataset' do
        ...
        it 'Allows to clone json dataset' do
          post "/dataset/#{dataset_id}/clone", params: {"loggedUser": {"role": "admin", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
