    ...
    context 'For specific dataset' do
      context 'Rest dataset' do
        ...
        it 'Allows to create rest dataset without tags' do
          post '/dataset', params: {"loggedUser": {"role": "manager", "apps": ["gfw","prep"], "id": "3242-32442-432"},
        ...
        it 'Allows to create rest dataset by a admin with tags and topics' do
          post '/dataset', params: {"loggedUser": {"role": "admin", "apps": ["gfw","prep"], "id": "3242-32442-432"},
                                    "dataset": {"provider": "cartodb", "tableName": "public.carts_test_endoint", "application": ["gfw"],
                                                 "connectorUrl": "https://rschumann.cartodb.com/api/v2/sql?q=select%20*%20from%20public.carts_test_endoint",
                                                 "name": "Carto test api", "format": 0, "data_path": "rows", "attributesPath": "fields",
        ...
        it 'Allows to update dataset' do
          put "/dataset/#{dataset_id}", params: {"loggedUser": {"role": "manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
        ...
        it 'Allows to add layers to existing dataset' do
          put "/dataset/#{dataset_id}/layer", params: {"loggedUser": {"role": "manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
        ...
        it 'Do not allow to overwrite not a json dataset' do
          post "/dataset/#{dataset_id}/data-overwrite", params: {"loggedUser": {"role": "manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
                                                                 "dataset": {"data": [
      ...
      context 'Json dataset' do
        ...
        it 'Allows to update dataset' do
          patch "/dataset/#{dataset_id}", params: {"loggedUser": {"role": "manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
        ...
        it 'Do not allow to overwrite locked json dataset data' do
          post "/dataset/#{locked_dataset_id}/data-overwrite", params: {"loggedUser": {"role": "manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"},
                                                                        "dataset": {"data": [
                                                                                       {"cartodbId": 10,"iso": "BRA","name": "Brazil","year": "2016","population": 999999},
                                                                                       {"cartodbId": 11,"iso": "BRA","name": "Brazil","year": "2016","population": 888888}]}}
        ...
        it 'Allows to delete dataset data' do
          delete "/dataset/#{dataset_id}/data/e3b4acca-d34d-46b9-833f-08c3a14fe2f5", params: {"loggedUser": {"role": "manager", "apps": ["gfw","wrw"], "id": "3242-32442-432"}, "dataset": {"id": "#{dataset_id}"}}
